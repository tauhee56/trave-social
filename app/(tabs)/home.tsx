...
const styles = StyleSheet.create({
  ...
  searchBar: {
    ...
    borderRadius: 22, flexDirection: "row", alignItems: "center", justifyContent: "flex-end", paddingHorizontal: 16,
  },
  searchText: { marginLeft: 8, color: "#222", textAlign: 'right' },
            ...
            <View style={styles.headerSection}>
              ...
              <ScrollView
                ...
                contentContainerStyle={[
                  { paddingHorizontal: 8 },
                  MIRROR_HOME && { flexDirection: 'row-reverse', flexGrow: 1 },
                ]}
              >
                {categories.map((cat) => (
                  <TouchableOpacity
