...
// Import and re-export from parent file
import firebaseHelpersDefault from '../firebaseHelpers';

// Auth functions - only get from firebaseHelpersDefault if not in individual modules
