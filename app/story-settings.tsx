          ...
          <View style={{ marginBottom: 12 }}>
            ...
            >
              <View style={{ flex: 1 }}>
                ...
                <Text style={{ fontSize: 12, color: '#999', marginTop: 2 }}>All users can view</Text>
              </View>
          ...
          <View style={{ marginBottom: 12 }}>
            ...
            >
              <View style={{ flex: 1 }}>
                ...
                <Text style={{ fontSize: 12, color: '#999', marginTop: 2 }}>Only your followers</Text>
              </View>
          ...
          <View style={{ marginBottom: 12 }}>
            ...
            >
              <View style={{ flex: 1 }}>
                ...
                <Text style={{ fontSize: 12, color: '#999', marginTop: 2 }}>Only close friends</Text>
              </View>
        ...
        <View style={{ paddingHorizontal: 16, paddingVertical: 20, borderBottomWidth: 1, borderBottomColor: '#eee' }}>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingVertical: 12, paddingHorizontal: 12, backgroundColor: '#f9f9f9', borderRadius: 8, marginBottom: 10 }}>
            <View style={{ flex: 1 }}>
              ...
              <Text style={{ fontSize: 12, color: '#999', marginTop: 2 }}>Allow tagging in stories</Text>
            </View>
            <Switch 
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingVertical: 12, paddingHorizontal: 12, backgroundColor: '#f9f9f9', borderRadius: 8 }}>
            <View style={{ flex: 1 }}>
              ...
              <Text style={{ fontSize: 12, color: '#999', marginTop: 2 }}>Allow others to download</Text>
            </View>
            <Switch 
        ...
        <View style={{ paddingHorizontal: 16, paddingVertical: 20, borderBottomWidth: 1, borderBottomColor: '#eee' }}>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingVertical: 12, paddingHorizontal: 12, backgroundColor: '#f9f9f9', borderRadius: 8 }}>
            <View style={{ flex: 1 }}>
              ...
              <Text style={{ fontSize: 12, color: '#999', marginTop: 2 }}>Appear in hashtag stories</Text>
            </View>
            <Switch 
